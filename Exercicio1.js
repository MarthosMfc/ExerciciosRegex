...
const texto = `Maria foi ao Na Hora e recebeu seu novo CPF (772.843.809-34), porém, 
para confirmar o número do seu novo documento, foi pedido que na hora de digitar no sistema, 
...
console.log(texto2.match(/(\d+\/\d+\/\d+)|(\d+\:\d+)/g))
...
console.log(str.match(/(https:\/\/)?\w+\.\w{2,}/gm))
...
console.log(texto4.match(/<h1>.*<\/h1>/gm))